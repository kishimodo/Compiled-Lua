return {
    ...
    requires        = {},
    requires_native = {
        { dll = "libsodium.dll", mode_default = "embed", env_var = "LUAVM_SODIUM_DLL" },
    },
}
