...
#define CLUA_VERSION_MINOR      2
#define CLUA_VERSION_PATCH      0
#define CLUA_VERSION_PRERELEASE "beta.4"          /* "" for a final release */
#define CLUA_VERSION_STRING     "0.2.0-beta.4"    /* MAJOR.MINOR.PATCH[-PRERELEASE] */
