return {
    ...
    requires        = {},
    requires_native = {
        { dll = "lmdb.dll", mode_default = "embed", env_var = "LUAVM_LMDB_DLL" },
    },
}
