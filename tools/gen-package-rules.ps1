...
# clua/src/runtime/packages/. Replaces the hand-written PACKAGE_<X>_*
...
#       -PackagesDir "clua/src/runtime/packages" `
...
[void]$mk.AppendLine('# Re-runs whenever any clua/src/runtime/packages/**/*.lua changes.')
[void]$mk.AppendLine()
