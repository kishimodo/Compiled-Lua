@echo off
rem LuaVM test runner. Builds the products, then runs the auto-discovering Lua
...
rem build.bat). Override LUAVM_MINGW_BIN / LUAVM_MAKE_BIN if your bundle differs.
